...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 26, 2020 at 05:54 PM
...
(2, '2020-03-21', '15:08:08', 1, 4156, 23, 'SVCBL', 'NORMAL', 'MAINS', 'MAINS', 'CORRECT', 'OK', 'ON LINE', 'ON LINE', 'OK', 'GOOD', NULL, 'YES', 'PASS', 2),
(3, '2020-03-22', '14:05:02', 1, 4156, 24, 'SVCBL', 'NORMAL', 'MAINS', 'MAINS', 'CORRECT', 'OK', 'ON LINE', 'ON LINE', 'OK', 'GOOD', NULL, 'YES', 'PASS', 2),
(4, '2020-03-23', '16:28:16', 1, 4156, 24, 'SVCBL', 'NORMAL', 'MAINS', 'MAINS', 'CORRECT', 'OK', 'ON LINE', 'OM LINE', 'OK', 'GOOD', NULL, 'YES', 'PASS', 2),
(5, '2020-03-24', '14:01:01', 1, 4156, 24, 'SVCBL', 'NORMAL', 'MAINS', 'MAINS', 'CORRECT', 'OK', 'ON LINE', 'ON LINE', 'OK', 'GOOD', NULL, 'YES', 'PASS', 2),
(6, '2020-03-25', '23:35:25', 1, 4156, 24, 'SVCBL', 'NORMAL', 'MAINS', 'MAINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2),
(7, '2020-03-26', '11:57:01', 1, 4156, 24, 'SVCBL', 'NORMAL', 'MAINS', 'MAINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2);
...
(1, 4156, '25', 'Temperature exceeds 24 degrees', '2020-03-22', '14:06:07'),
(2, 4156, '26', 'Temperature exceeds 24 degrees', '2020-03-23', '16:28:16'),
(3, 4156, 'NORM', 'Status of ups not NORMAL', '2020-03-23', '16:28:16'),
(4, 4156, 'MAI', 'Status of ServerB is not MAINS', '2020-03-23', '16:28:16'),
(5, 4156, '25', 'Temperature not normal(update)', '2020-03-23', '16:28:24'),
(6, 4156, 'NORM', 'Status of ups not NORMAL(update)', '2020-03-23', '16:28:24'),
(7, 4156, 'MAI', 'Status of ServerB is not MAINS(update)', '2020-03-23', '16:28:24'),
(8, 4156, '25', 'Temperature not normal(update)', '2020-03-23', '16:28:30'),
(9, 4156, 'NORM', 'Status of ups not NORMAL(update)', '2020-03-23', '16:28:30'),
(10, 4156, '26', 'Temperature not normal(update)', '2020-03-23', '16:28:38'),
(11, 4156, 'All parameters NORMAL', 'Parameter/s fixed', '2020-03-23', '16:28:38'),
(12, 4156, '25', 'Temperature exceeds 24 degrees', '2020-03-24', '14:01:01'),
(13, 4156, 'HIGH', 'Status of ups not NORMAL', '2020-03-24', '14:01:01'),
(14, 4156, 'NOT MAINS', 'Status of ServerB is not MAINS', '2020-03-24', '14:01:01'),
(15, 4156, '26', 'Temperature not normal(update)', '2020-03-24', '14:01:11'),
(16, 4156, 'All parameters NORMAL', 'Parameter/s fixed', '2020-03-24', '14:01:11'),
(17, 4156, '25', 'Temperature exceeds 24 degrees', '2020-03-26', '11:57:01'),
(18, 4156, 'NOT NORMAL', 'Status of ups not NORMAL', '2020-03-26', '11:57:01'),
(19, 4156, 'NOT NORMAL', 'Status of ups not NORMAL(update)', '2020-03-26', '12:26:47'),
(20, 4156, '25', 'Temperature not normal(update)', '2020-03-26', '12:26:57'),
(21, 4156, 'NOT NORMAL', 'Status of ups not NORMAL(update)', '2020-03-26', '12:27:05'),
(22, 4156, 'All parameters NORMAL', 'Parameter/s fixed', '2020-03-26', '12:27:30');
...
(1, '2020-03-12', '11:08:08', 1, 4156, 'B', 210, 230, 'OK', 'OK', 'OK', 'GOOD', 15, 'OK', 'OK', 'Residual dust was found on the system. Cleaning was performed.', 'YES'),
(2, '2020-03-19', '10:05:05', 1, 4156, 'A', 230, 230, 'OK', 'OK', 'OK', 'GOOD', 15, 'OK', 'OK', NULL, NULL),
(3, '2020-03-23', '15:00:46', 1, 4156, 'A', 200, 230, 'OK', 'OK', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(1, 4156, 'UPS_ip not in corrent range', '190', '2020-03-23', '15:00:46'),
(2, 4156, 'Not Dustfree', 'NOT OK', '2020-03-23', '15:00:46'),
(3, 4156, 'Parameter/s fixed', 'All parameters NORMAL', '2020-03-23', '15:01:04');
...
('26jnezg6e8hdl5w0px1o7a33211u7ivo', 'MzFhZWNmYzgzODA0YmYxZmY2ZTY0MmFiZTFiNzBhNTY2ZDU0NWVjZTp7InR5cGUiOiJzIn0=', '2020-04-08 15:43:15.857334');
...
INSERT INTO `dscndaily` (`date`, `a_id`, `emp_id`, `f_id`, `SAT_LED`, `ODU_LED`, `IO_LED`, `Alarm_LED`, `Power_LED`, `V35_LED`, `IP_Voltage`, `OP_voltage`, `Battery_Voltage`, `CorO_function`, `REMARKS`, `Unit_incharge_approval`) VALUES
('2020-03-24 10:36:08', 1, 4144, '3', 'STEADY ON', 'STEADY ON', 'STEADY ON', 'OFF', 'STEADY ON', 'RX/TX BLINKING', 230, 220, 210, 'OK', NULL, 'YES'),
('2020-03-24 10:36:11', 1, 4169, '3', 'STEADY ON', 'STEADY ON', 'STEADY ON', 'ON', 'STEADY ON', 'RX/TX BLINKING', 230, 200, 170, 'OK', 'Alarm LED found ON.\r\nLess voltage generated at the output side of the UPS. This giving rise to even lesser and insufficient battery voltage of 170V.\r\nIssue no 518. Referred to AGM-CE', 'NO');
...
CREATE TABLE IF NOT EXISTS `vhfdaily` (
  ...
  `time` time NOT NULL,
  `emp_id` int(11) DEFAULT NULL,
  `f_id` varchar(10) NOT NULL DEFAULT '1',
  `a_id` int(11) NOT NULL,
...
INSERT INTO `vhfmonthly` (`date`, `emp_id`, `f_id`, `a_id`, `modulation_mode`, `line_op`, `squelch_defeat`, `squelch_threshold`, `squelch_carrier_override`, `RF_pre_ATTN`, `AGC`, `Ready_signal`, `Squelch_op_marc`, `Squelch_op_facilities`, `Squelch_op_phantom`, `Squelch_defeat_ip`, `bit_test`, `REMARKS`, `Unit_incharge_approval`) VALUES
('2020-03-23 12:37:58', 4169, '1', 1, 'AM-Voice', 12, 'OFF', -107, 'OFF', 'OFF', 'ON', 'STD', 'STD', 'STD', 'STD', 'STD', 'PASS', NULL, 'YES'),
('2020-04-23 12:38:01', 4156, '1', 1, 'AM-Voice', 11, 'ON', -103, 'OFF', 'OFF', 'ON', 'NO', 'STD', 'STD', 'STD', 'STD', 'PASS', 'Issue no. 504. Squelch defeat observed to be ON. Ready Signal being NON-STD. Referred to AGM-CE', 'NO'),
('2020-05-23 12:38:04', 4156, '1', 1, 'FM-Voice', 12, 'OFF', -105, 'OFF', 'OFF', 'ON', 'STD', 'STD', 'STD', 'STD', 'STD', 'PASS', NULL, 'YES'),
('2020-06-23 12:38:06', 4169, '1', 1, 'PM-Voice', 10, 'OFF', -107, 'OFF', 'OFF', 'ON', 'STD', 'STD', 'STD', 'STD', 'STD', 'PASS', NULL, 'YES');
...
INSERT INTO `vhfyearly` (`date`, `emp_id`, `f_id`, `a_id`, `RX_no`, `frequency_MHz`, `reference_freq`, `power`, `bit_test`, `AC_DC_changeover`, `Remarks`, `Unit_incharge_approval`) VALUES
('2020-03-23 12:39:23', 4144, '1', 1, 1, 120, 20.95, 26, 'PASS', 'NORMAL(DC)', NULL, 'YES'),
('2021-03-23 12:39:25', 4169, '1', 1, 1, 119, 20.95, 43, 'FAIL', 'Abnormal(DC)', 'Bit test failure and abnormal AC to DC changeover observed. Referred to AGM-CE.\r\nIssue no. 517', 'NO');
