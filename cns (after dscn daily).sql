...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 29, 2020 at 08:19 AM
...
CREATE TABLE IF NOT EXISTS `dscndaily` (
  ...
  `a_id` int(11) NOT NULL,
  `emp_id` int(11) DEFAULT NULL,
  `f_id` varchar(10) NOT NULL DEFAULT '3',
...
INSERT INTO `dscndaily` (`dscndaily_id`, `date`, `time`, `a_id`, `emp_id`, `f_id`, `SAT_LED`, `ODU_LED`, `IO_LED`, `Alarm_LED`, `Power_LED`, `V35_LED`, `IP_Voltage`, `OP_voltage`, `Battery_Voltage`, `CorO_function`, `REMARKS`, `Unit_incharge_approval`) VALUES
(1, '2020-03-26', '13:14:06', 1, 4144, '3', 'STEADY ON', 'STEADY ON', 'STEADY ON', 'OFF', 'STEADY ON', 'RX/TX BLINKING', 230, 220, 210, 'OK', NULL, 'YES'),
(2, '2020-03-27', '16:05:04', 1, 4169, '3', 'STEADY ON', 'STEADY ON', 'STEADY ON', 'OFF', 'STEADY ON', 'RX/TX BLINKING', 230, 230, 190, 'OK', 'Alarm LED found ON.\r\nLess voltage generated at the output side of the UPS. This giving rise to even lesser and insufficient battery voltage of 170V.\r\nIssue no 518. Issue was solved on the same day.', 'YES'),
(3, '2020-03-28', '23:50:12', 1, 4144, '3', 'STEADY ON', 'STEADY ON', 'STEADY ON', 'OFF', 'STEADY ON', 'RX/TX BLINKING', 230, 230, 195, 'OK', 'UPS I/P,O/P very low. ', 'YES'),
(4, '2020-03-29', '01:13:31', 1, 4169, '3', 'STEADY ON', 'STEADY ON', 'STEADY ON', 'OFF', 'STEADY ON', 'RX/TX BLINKING', 230, 230, 200, 'OK', 'Alarm LED is ON. it was tuned off successfully', 'YES');
