...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 26, 2020 at 09:35 AM
...
INSERT INTO `vhfdaily` (`date`, `emp_id`, `f_id`, `a_id`, `RX_no`, `frequency_MHz`, `bit_test`, `status`, `RXN_check`, `ACorDC_CorO`, `SQ_threshold`, `Remarks`, `Unit_Incharge_Approval`) VALUES
('2020-03-23 12:31:17', 4144, '1', 1, 1, 120, 'PASS', 'READY', 'NORMAL', 'C/O NORMAL', -85, 'SQ threshold < -80 DBm as expected.\r\nMaintenance carried out for VHF RX for model type of PAE.', 'YES'),
('2020-03-24 12:31:21', 4144, '1', 1, 1, 122, 'FAIL', 'NOT READY', 'RXN NORMAL', 'C/O NORMAL', -79, 'Referred to AGM_CE.Issue no 503', 'NO'),
('2020-03-25 12:31:25', 4156, '1', 1, 1, 119, 'PASS', 'READY', 'RXN NORMAL', 'C/O NORMAL', -82, NULL, 'YES');
