...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 22, 2020 at 10:17 AM
...
CREATE TABLE IF NOT EXISTS `cdvordaily` (
  ...
  `approval_time` int(11) DEFAULT NULL,
  PRIMARY KEY (`p_id`),
  KEY `emp_id` (`emp_id`),
...
(2, '2020-04-21', '17:11:00', 'PENDING', 1, 4123, 1, 23, 28, 32, 17, 1, 11, NULL, NULL, NULL, NULL);
...
(2, '2020-04-21', '09:06:10', 1, 4156, 1, 'PENDING', 5, 5, 3, 56, 67, 45, 456, 67, '234', 546, 435, 345, 'xcg cgbxbvc', NULL, NULL, NULL);
...
(65, '2020-04-22', '00:45:25', 1, 4156, 'PENDING', 2, 25, 'SVCBL', 'NORMAL', 'MAINS', 'STANDBY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(108, 4156, 65, '25', 'Temperature exceeds 24 degrees', '2020-04-22', '00:45:25'),
(109, 4156, 65, 'bye', 'Final submit with errors', '2020-04-22', '00:45:57');
...
(33, '2020-04-22', '13:17:34', 1, 2, 4156, 'COMPLETED', 'A', 220, 230, 'OK', 'OK', NULL, NULL, NULL, NULL, NULL, NULL, 'YES', '2020-04-22', '00:08:53');
