...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 25, 2020 at 03:12 PM
...
('1', 1, 'VHF TX/RX', 'PAE', 'T6T', 50, '2009-06-15', '2009-06-20', 'E/ROOM', 4169),
('2', 1, 'DATIS', 'TERMA', '50209', NULL, '2008-11-01', '2009-01-01', 'E/ROOM', 4169),
...
INSERT INTO `datisdaily` (`date`, `a_id`, `emp_id`, `f_id`, `room_temp`, `status_of_AC`, `status_of_UPS`, `status_of_serverA`, `status_of_serverB`, `datetime_of_servers_wrt_GPS_CLK`, `status_of_Disk_array`, `VHFTX_ATIS_status`, `VHFRX_ATIS_status`, `DATIS_update`, `Audio_quality`, `REMARKS`, `Unit_incharge_approval`) VALUES
('2020-03-23 10:59:57', 1, 4144, '2', 24, 'SVCBL', 'NORMAL', 'MAINS', 'MAINS', 'CORRECT', 'OK', 'ON LINE', 'ON LINE', 'OK', 'GOOD', NULL, 'YES');
...
INSERT INTO `datisweekly` (`date`, `a_id`, `emp_id`, `f_id`, `serverAorB`, `UPS_ip`, `UPS_op`, `Dust_free`, `LAN_status`, `time_sync`, `Audio_quality`, `ptt_off_interval_seconds`, `main_to_standby_changeover`, `status_of_ROP`, `REMARKS`, `Unit_incharge_approval`) VALUES
('2020-03-24 10:08:33', 1, 4156, '2', 'B', 210, 230, 'NO', 'OK', 'OK', 'GOOD', 15, 'OK', 'OK', 'Residual dust was found on the system. Cleaning was performed.', 'YES'),
('2020-03-31 10:26:08', 1, 4169, '2', 'A', 230, 230, 'YES', 'OK', 'OK', 'GOOD', 15, 'OK', 'OK', NULL, 'YES');
...
(1101, 'Hannibal Lecter', 'ED CNS', NULL),
