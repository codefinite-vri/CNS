...
--
-- Host: localhost
-- Generation Time: Mar 31, 2020 at 09:15 PM
...
INSERT INTO `datisdaily` (`datisdaily_id`, `date`, `time`, `a_id`, `emp_id`, `f_id`, `room_temp`, `status_of_AC`, `status_of_UPS`, `status_of_serverA`, `status_of_serverB`, `datetime_of_servers_wrt_GPS_CLK`, `status_of_Disk_array`, `VHFTX_ATIS_status`, `VHFRX_ATIS_status`, `DATIS_update`, `Audio_quality`, `REMARKS`, `Unit_incharge_approval`, `test`) VALUES
(1, '2020-03-24', '15:14:07', 1, 4156, 2, 24, 'SVCBL', 'NORMAL', 'MAINS', 'MAINS', 'CORRECT', 'OK', 'ON LINE', 'ON LINE', 'OK', 'GOOD', NULL, 'YES', 'PASS'),
(2, '2020-03-25', '15:08:08', 1, 4156, 2, 23, 'SVCBL', 'NORMAL', 'MAINS', 'MAINS', 'CORRECT', 'OK', 'ON LINE', 'ON LINE', 'OK', 'GOOD', NULL, 'YES', 'PASS'),
(3, '2020-03-26', '14:05:02', 1, 4156, 2, 24, 'SVCBL', 'NORMAL', 'MAINS', 'MAINS', 'CORRECT', 'OK', 'ON LINE', 'ON LINE', 'OK', 'GOOD', NULL, 'YES', 'PASS'),
(4, '2020-03-27', '16:28:16', 1, 4156, 2, 24, 'SVCBL', 'NORMAL', 'MAINS', 'MAINS', 'CORRECT', 'OK', 'ON LINE', 'OM LINE', 'OK', 'GOOD', NULL, 'YES', 'PASS'),
(5, '2020-03-28', '14:01:01', 1, 4144, 2, 24, 'SVCBL', 'NORMAL', 'MAINS', 'MAINS', 'CORRECT', 'OK', 'ON LINE', 'ON LINE', 'OK', 'GOOD', NULL, 'YES', 'PASS'),
(6, '2020-03-29', '23:35:25', 1, 4144, 2, 24, 'SVCBL', 'NORMAL', 'MAINS', 'MAINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(7, '2020-03-30', '11:57:01', 1, 4156, 2, 24, 'SVCBL', 'NORMAL', 'MAINS', 'MAINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(10, '2020-03-31', '16:41:26', 1, 4156, 2, 24, 'SVCBL', 'NORMAL', 'MAINS', 'MAINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `datisdlogs` (`log_id`, `emp_id`, `value`, `Remarks`, `Date`, `time`) VALUES
(1, 4156, '25', 'Temperature exceeds 24 degrees', '2020-03-24', '14:01:01'),
(2, 4156, 'HIGH', 'Status of ups not NORMAL', '2020-03-24', '14:01:01'),
(3, 4156, 'NOT MAINS', 'Status of ServerB is not MAINS', '2020-03-24', '14:01:01'),
(4, 4156, '26', 'Temperature not normal(update)', '2020-03-24', '14:01:11'),
(5, 4156, 'All parameters NORMAL', 'Parameter/s fixed', '2020-03-24', '14:01:11'),
(6, 4156, '25', 'Temperature exceeds 24 degrees', '2020-03-26', '11:57:01'),
(7, 4156, 'NOT NORMAL', 'Status of ups not NORMAL', '2020-03-26', '11:57:01'),
(8, 4156, 'NOT NORMAL', 'Status of ups not NORMAL(update)', '2020-03-26', '12:26:47'),
(9, 4156, '25', 'Temperature not normal(update)', '2020-03-26', '12:26:57'),
(10, 4156, 'NOT NORMAL', 'Status of ups not NORMAL(update)', '2020-03-26', '12:27:05'),
(11, 4156, 'All parameters NORMAL', 'Parameter/s fixed', '2020-03-26', '12:27:30');
...
CREATE TABLE `datisweekly` (
  `datisweekly_id` int(11) NOT NULL,
  `date` date NOT NULL,
  `time` time DEFAULT NULL,
  `a_id` int(11) DEFAULT NULL,
  `f_id` int(11) NOT NULL,
...
INSERT INTO `datisweekly` (`datisweekly_id`, `date`, `time`, `a_id`, `f_id`, `emp_id`, `serverAorB`, `UPS_ip`, `UPS_op`, `Dust_free`, `LAN_status`, `time_sync`, `Audio_quality`, `ptt_off_interval_seconds`, `main_to_standby_changeover`, `status_of_ROP`, `REMARKS`, `Unit_incharge_approval`) VALUES
(1, '2020-03-11', '11:08:08', 1, 2, 4156, 'B', 210, 230, 'OK', 'OK', 'OK', 'GOOD', 15, 'OK', 'OK', 'Residual dust was found on the system. Cleaning was performed.', 'YES'),
(2, '2020-03-18', '10:05:05', 1, 2, 4156, 'A', 230, 230, 'OK', 'OK', 'OK', 'GOOD', 15, 'OK', 'OK', NULL, NULL),
(3, '2020-03-25', '15:00:46', 1, 2, 4156, 'A', 200, 230, 'OK', 'OK', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `datiswlogs` (`logs_id`, `emp_id`, `Remarks`, `value`, `date`, `time`) VALUES
(1, 4156, 'UPS_ip not in corrent range', '190', '2020-03-25', '15:00:46'),
(2, 4156, 'Not Dustfree', 'NOT OK', '2020-03-25', '15:00:46'),
(3, 4156, 'Parameter/s fixed', 'All parameters NORMAL', '2020-03-25', '15:01:04');
...
('26jnezg6e8hdl5w0px1o7a33211u7ivo', 'MzFhZWNmYzgzODA0YmYxZmY2ZTY0MmFiZTFiNzBhNTY2ZDU0NWVjZTp7InR5cGUiOiJzIn0=', '2020-04-12 08:18:40.747913'),
...
(1, '2020-03-26', '13:14:06', 1, 3, 4169, 'STEADY ON', 'STEADY ON', 'STEADY ON', 'OFF', 'STEADY ON', 'RX/TX BLINKING', 230, 220, 210, 'OK', NULL, 'YES'),
(2, '2020-03-27', '16:05:04', 1, 3, 4169, 'STEADY ON', 'STEADY ON', 'STEADY ON', 'OFF', 'STEADY ON', 'RX/TX BLINKING', 230, 230, 190, 'OK', 'Alarm LED found ON.\r\nLess voltage generated at the output side of the UPS. This giving rise to even lesser and insufficient battery voltage of 170V.\r\nIssue no 518. Issue was solved on the same day.', 'YES'),
(3, '2020-03-28', '23:50:12', 1, 3, 4169, 'STEADY ON', 'STEADY ON', 'STEADY ON', 'OFF', 'STEADY ON', 'RX/TX BLINKING', 230, 230, 195, 'OK', 'UPS I/P,O/P very low. ', 'YES'),
(4, '2020-03-29', '01:13:31', 1, 3, 4169, 'STEADY ON', 'STEADY ON', 'STEADY ON', 'OFF', 'STEADY ON', 'RX/TX BLINKING', 230, 230, 200, 'OK', 'Alarm LED is ON. it was tuned off successfully', 'YES');
...
INSERT INTO `dscnmonthly` (`date`, `a_id`, `emp_id`, `f_id`, `Cleaning_DSCN_associated_eqpt`, `Battery_backup_time_of_UPS1nUPS2`, `UPS_battery_voltage_on_load`, `Antenna_n_cable_check`, `Earth_resistance`, `EorN_voltage`, `eqpt_status_after_check`, `REMARKS`, `Unit_incharge_approval`) VALUES
('2020-03-22 13:31:25', 1, 4156, 2, 'Cleaning performed.', '15hrs ', 'Can withstand load ', 'All antennas and cables properly connected.', 'All connections are maintained.', 25, 'GOOD', NULL, 'YES');
...
INSERT INTO `dscnweekly` (`date`, `a_id`, `emp_id`, `f_id`, `Air_conditioning_check`, `Cleaning_DSCN_associated_eqpt`, `UPS1_UPS2_battery_backup`, `UPS_battery_voltage_on_load`, `Antenna_n_Cable_check`, `REMARKS`, `Unit_incharge_approval`) VALUES
('2020-03-22 13:40:14', 1, 4156, 1, 'ALL installed AC\'s working.', 'ALL DSCN related equipments were cleaned.', 'UPS1 & UPS2 battery backup maintained.', 'Can withstand load', 'All cables and Antenna properly connected', NULL, 'YES');
...
(1, '2020-03-23', '11:04:05', 4144, 1, 1, 1, 120, 'PASS', 'READY', 'RXN NORMAL', 'C/O NORMAL', -85, 'SQ threshold < -80 DBm as expected.\r\nMaintenance carried out for VHF RX for model type of PAE.', 'YES'),
(2, '2020-03-24', '12:04:07', 4144, 1, 1, 1, 122, 'PASS', 'READY', 'RXN NORMAL', 'C/O NORMAL', -81, 'Pass', 'YES'),
(3, '2020-03-25', '15:06:06', 4144, 1, 1, 1, 119, 'PASS', 'READY', 'RXN NORMAL', 'C/O NORMAL', -82, NULL, 'YES'),
(4, '2020-03-26', '22:37:04', 4144, 1, 1, 1, 123, 'PASS', 'READY', 'RXN NORMAL', NULL, -82, NULL, 'YES'),
(5, '2020-03-27', '11:02:13', 4144, 1, 1, 1, 120, 'PASS', 'READY', 'RXN NORMAL', NULL, -83, NULL, 'YES');
...
(1, 4144, 'Bit test failed', 'FAIL', '2020-03-26', '22:37:04'),
(2, 4144, 'Not Ready', 'NOT READY', '2020-03-26', '22:37:04'),
(3, 4144, 'SQ Threshold above -80 Db', '-82', '2020-03-26', '22:37:04'),
(4, 4144, 'Not Ready(update)', 'NOT READY', '2020-03-26', '22:37:39'),
(5, 4144, 'SQ Threshold above -80 Db(update)', '-82', '2020-03-26', '22:37:39'),
(6, 4144, 'SQ Threshold above -80 Db(update)', '-82', '2020-03-26', '22:37:57'),
(7, 4144, 'Parameter/s fixed', 'All parameters NORMAL', '2020-03-26', '22:37:57'),
(8, 4144, 'Bit test failed', 'READY', '2020-03-27', '11:02:13'),
(9, 4144, 'Not Ready', 'OK', '2020-03-27', '11:02:13'),
(10, 4144, 'SQ Threshold above -80 Db', '-83', '2020-03-27', '11:02:13'),
(11, 4144, 'SQ Threshold above -80 Db(update)', '-83', '2020-03-27', '11:02:29'),
(12, 4144, 'Parameter/s fixed', 'All parameters NORMAL', '2020-03-27', '11:02:29');
...
(1, '2020-01-27', '11:24:47', 4144, 1, 1, 'AM-Voice', 12, 'OFF', -107, 'OFF', 'OFF', 'ON', 'STD', 'STD', 'STD', 'STD', 'STD', 'OK', NULL, 'YES'),
(2, '2020-02-26', '11:24:57', 4144, 1, 1, 'AM-Voice', 11, 'OFF', -103, 'OFF', 'OFF', 'ON', 'STD', 'STD', 'STD', 'STD', 'STD', 'OK', '', 'YES'),
...
(1, '2018-03-29', '15:20:34', 4144, 1, 1, 1, 119, 20.95, 43, 'PASS', 'NORMAL(DC)', 'Every parameter was observed to be normal.', 'YES'),
(2, '2019-03-29', '11:40:12', 4144, 1, 1, 1, 120, 20.95, 26, 'PASS', 'NORMAL(DC)', NULL, 'YES'),
...
ALTER TABLE `cdvordaily`
  ADD PRIMARY KEY (`date`,`a_id`,`f_id`),
...
ALTER TABLE `datisweekly`
  ADD PRIMARY KEY (`datisweekly_id`),
  ADD UNIQUE KEY `date` (`date`,`a_id`) USING BTREE,
  ADD KEY `a_id` (`a_id`),
  ADD KEY `emp_id` (`emp_id`),
  ADD KEY `f_id` (`f_id`);
...
--
ALTER TABLE `datisdaily`
  MODIFY `datisdaily_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `datisweekly`
  MODIFY `datisweekly_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `dscndaily`
  MODIFY `dscndaily_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `vhfdaily`
  MODIFY `vhfdaily_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `vhfmonthly`
  MODIFY `vhfmonthly_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `vhfyearly`
--
ALTER TABLE `vhfyearly`
  MODIFY `vhfyearly_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
